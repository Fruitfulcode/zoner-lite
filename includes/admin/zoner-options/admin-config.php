...
if ( ! class_exists( 'zoner_config' ) ) {
	...
	class zoner_config {
		...
		function fruitful_advertising_notice() {
			...
			$advertising_enable = apply_filters('ffc_is_advertising_enabled_zoner_lite', false);

			if( $advertising_enable ) {

				global $pagenow;
				if ( ( $pagenow === 'themes.php' ) && ( isset($_GET['page']) && $_GET['page'] === 'zoner_options' ) ) {
					$advertising_html = apply_filters('ffc_advertising_zoner_lite', null);
                        ...
                        <a href="<?php echo wp_customize_url(); ?>" class="load-customize hide-if-no-customize"
                           title="<?php echo esc_attr( $customize_title ); ?>">
                            <img src="<?php echo esc_url( $screenshot ); ?>"
                                 alt="<?php esc_attr_e( 'Current theme preview', 'zoner-lite' ); ?>"/>
                        </a>
					<?php endif; ?>
			...
			$this->sections[] = array(
				...
				'fields'    => array(
					...
					array(
						...
						'options' => array(
							'0' => array(
								'alt' => 'No widgets areas.',
								'img' => $sample_patterns_url . 'images/footer-widgets-0.png'
							),
							'1' => array(
								'alt' => '1 column area.',
								'img' => $sample_patterns_url . 'images/footer-widgets-1.png'
							),
							'2' => array(
								'alt' => '2 column area.',
								'img' => $sample_patterns_url . 'images/footer-widgets-2.png'
							),
							'3' => array(
								'alt' => '3 column area.',
								'img' => $sample_patterns_url . 'images/footer-widgets-3.png'
							),
							'4' => array(
								'alt' => '4 column area.',
								'img' => $sample_patterns_url . 'images/footer-widgets-4.png'
							)
						),
						'default' => '4'
					),
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'footer_credit'      => '<span id="footer-thankyou">' . __( 'Zoner Options panel created using "Reduxe Framework".', 'zoner-lite' ) . '</span>',
				// Disable the footer credit of zoner. Please leave if you can help it.
