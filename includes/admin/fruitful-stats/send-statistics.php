...
function fruitful_build_stats_info_array() {
	...
	global $wp_version, $zoner_config;
...
function fruitful_send_stats_on_save( $value, $old_value ) {
	...
	if ( $value['ffc_subscribe'] !== $old_value['ffc_subscribe'] ||
		...
		add_action( 'redux/options/zoner_config/saved', 'fruitful_send_stats', 10, 3 );
	}

	return $value;
}

add_filter( 'pre_update_option_zoner_config', 'fruitful_send_stats_on_save', 10, 3 );
