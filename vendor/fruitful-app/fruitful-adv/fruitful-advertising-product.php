<?php
	...
	class FruitfulZonerLite_Adv extends FruitfulAdv
	{
		...
		public function __construct($root_file, $product_type)
		{
			...
			add_filter('ffc_is_advertising_enabled_zoner_lite', array($this, 'is_advertising_enabled'));

			// Add filter to displaying advertising
			add_filter('ffc_advertising_zoner_lite', array($this, 'get_advertising_html'));
		}
