...
class FruitfulZonerLiteApp {

	public $product_type = 'theme'; //{theme|plugin}

	public $product_option_name = 'zoner_config';
	...
	public function dispatch() {
		...
		$this->controller->statistic = new FruitfulZonerLite_Stats( $this->root_file, $this->product_type, $this->product_option_name );
		...
		$this->controller->advertising = new FruitfulZonerLite_Adv( $this->root_file, $this->product_type );
