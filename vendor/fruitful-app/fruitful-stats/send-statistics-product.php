...
class FruitfulZonerLite_Stats extends FruitfulStatistic {
	...
	public function general_stats_option_update( $value, $old_value ) {
		...
		if ( $value['ffc_subscribe'] !== $old_value['ffc_subscribe'] ||
			...
			$ffc_statistics_option['ffc_statistic']       = ( (int) $value['ffc_statistic'] === 1 ) ? 1 : 0;
			$ffc_statistics_option['ffc_subscribe']       = ( (int) $value['ffc_subscribe'] === 1 ) ? 1 : 0;
